...
export interface Depot {
  ...
  name: string;
  type:
    "central_hub" | "regional_depot" | "hospital" | "field_station" | "shelter";
  address: string;
  lat: number;
  lng: number;
  capacity: number;
  ...
  contactPhone: string;
  operatingStatus:
    "fully_operational" | "strained" | "at_capacity" | "evacuating";
  amenities: string[];
}
...
export type TeamStatus =
  "standby" | "dispatched" | "active_mission" | "demobilized";
...
export type ActiveTab =
  "feed" | "map" | "resources" | "volunteers" | "admin" | "report";
